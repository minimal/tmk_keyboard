...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_BSLS), \
         ...
         KC_NONUS_BSLASH /*backtick UK */ /* SHIFT(KC_3) */, SHIFT(KC_4), SHIFT(KC_9), SHIFT(KC_0), KC_GRAVE, \
         ...
         KC_FN1, SHIFT(KC_INS), KC_LALT, KC_FN4, KC_BSPC, KC_LCTL, KC_LGUI, \
  ...
  KC_DEL, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDN, KC_DOWN, KC_F4, KC_F5, KC_F6, KC_F11, \
         KC_NO, KC_NO, KC_NO, KC_NO, KC_FN3, SHIFT(KC_3) /*£*/, KC_F1, KC_F2, KC_F3, KC_F12, \
  KC_NO, KC_LSFT, KC_LALT, KC_FN4, KC_BSPC, KC_LCTL, KC_LGUI, KC_SPC, KC_FN2, KC_NO, KC_NO, KC_ENT)
};
